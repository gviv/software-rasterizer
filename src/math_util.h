...
m4_x8 operator*(const m4_x8& a, const m4_x8& b)
{
    ...
    res[0][0] = _mm256_fmadd_ps(a[0][0], b[0][0], _mm256_fmadd_ps(a[0][1], b[1][0], _mm256_fmadd_ps(a[0][2], b[2][0], a[0][3] * b[3][0])));
    res[0][1] = _mm256_fmadd_ps(a[0][0], b[0][1], _mm256_fmadd_ps(a[0][1], b[1][1], _mm256_fmadd_ps(a[0][2], b[2][1], a[0][3] * b[3][1])));
    res[0][2] = _mm256_fmadd_ps(a[0][0], b[0][2], _mm256_fmadd_ps(a[0][1], b[1][2], _mm256_fmadd_ps(a[0][2], b[2][2], a[0][3] * b[3][2])));
    res[0][3] = _mm256_fmadd_ps(a[0][0], b[0][3], _mm256_fmadd_ps(a[0][1], b[1][3], _mm256_fmadd_ps(a[0][2], b[2][3], a[0][3] * b[3][3])));

    res[1][0] = _mm256_fmadd_ps(a[1][0], b[0][0], _mm256_fmadd_ps(a[1][1], b[1][0], _mm256_fmadd_ps(a[1][2], b[2][0], a[1][3] * b[3][0])));
    res[1][1] = _mm256_fmadd_ps(a[1][0], b[0][1], _mm256_fmadd_ps(a[1][1], b[1][1], _mm256_fmadd_ps(a[1][2], b[2][1], a[1][3] * b[3][1])));
    res[1][2] = _mm256_fmadd_ps(a[1][0], b[0][2], _mm256_fmadd_ps(a[1][1], b[1][2], _mm256_fmadd_ps(a[1][2], b[2][2], a[1][3] * b[3][2])));
    res[1][3] = _mm256_fmadd_ps(a[1][0], b[0][3], _mm256_fmadd_ps(a[1][1], b[1][3], _mm256_fmadd_ps(a[1][2], b[2][3], a[1][3] * b[3][3])));

    res[2][0] = _mm256_fmadd_ps(a[2][0], b[0][0], _mm256_fmadd_ps(a[2][1], b[1][0], _mm256_fmadd_ps(a[2][2], b[2][0], a[2][3] * b[3][0])));
    res[2][1] = _mm256_fmadd_ps(a[2][0], b[0][1], _mm256_fmadd_ps(a[2][1], b[1][1], _mm256_fmadd_ps(a[2][2], b[2][1], a[2][3] * b[3][1])));
    res[2][2] = _mm256_fmadd_ps(a[2][0], b[0][2], _mm256_fmadd_ps(a[2][1], b[1][2], _mm256_fmadd_ps(a[2][2], b[2][2], a[2][3] * b[3][2])));
    res[2][3] = _mm256_fmadd_ps(a[2][0], b[0][3], _mm256_fmadd_ps(a[2][1], b[1][3], _mm256_fmadd_ps(a[2][2], b[2][3], a[2][3] * b[3][3])));

    res[3][0] = _mm256_fmadd_ps(a[3][0], b[0][0], _mm256_fmadd_ps(a[3][1], b[1][0], _mm256_fmadd_ps(a[3][2], b[2][0], a[3][3] * b[3][0])));
    res[3][1] = _mm256_fmadd_ps(a[3][0], b[0][1], _mm256_fmadd_ps(a[3][1], b[1][1], _mm256_fmadd_ps(a[3][2], b[2][1], a[3][3] * b[3][1])));
    res[3][2] = _mm256_fmadd_ps(a[3][0], b[0][2], _mm256_fmadd_ps(a[3][1], b[1][2], _mm256_fmadd_ps(a[3][2], b[2][2], a[3][3] * b[3][2])));
    res[3][3] = _mm256_fmadd_ps(a[3][0], b[0][3], _mm256_fmadd_ps(a[3][1], b[1][3], _mm256_fmadd_ps(a[3][2], b[2][3], a[3][3] * b[3][3])));
...
m4 inverse(const m4 &a)
{
    ...
    matrix[2][2] = a[2][2];
    matrix[2][3] = 0.0f;
    matrix[3][0] = -(a[3][0] * matrix[0][0] + a[3][1] * matrix[1][0] + a[3][2] * matrix[2][0]);
    matrix[3][1] = -(a[3][0] * matrix[0][1] + a[3][1] * matrix[1][1] + a[3][2] * matrix[2][1]);
    matrix[3][2] = -(a[3][0] * matrix[0][2] + a[3][1] * matrix[1][2] + a[3][2] * matrix[2][2]);
    matrix[3][3] = 1.0f;
...
m4_x8 inverse(const m4_x8 &a)
{
    ...
    matrix[2][2] = a[2][2];
    matrix[2][3] = zero;
    matrix[3][0] = zero - (a[3][0] * matrix[0][0] + a[3][1] * matrix[1][0] + a[3][2] * matrix[2][0]);
    matrix[3][1] = zero - (a[3][0] * matrix[0][1] + a[3][1] * matrix[1][1] + a[3][2] * matrix[2][1]);
    matrix[3][2] = zero - (a[3][0] * matrix[0][2] + a[3][1] * matrix[1][2] + a[3][2] * matrix[2][2]);
    matrix[3][3] = makeF32_x8(1.0f);
